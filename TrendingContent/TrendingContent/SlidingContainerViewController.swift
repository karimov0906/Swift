...
// MARK: Delegate Protocol for SlidingContainerViewController
...
class SlidingContainerViewController: UIViewController, UIScrollViewDelegate, SlidingContainerSliderViewDelegate {
    ...
    init (parent: UIViewController, contentViewControllers: [UIViewController], titles: [String]) {
        ...
        var rect = view.frame
        rect.origin.y = sliderView.frame.size.height
        rect.size.height -= sliderView.frame.size.height
...
// MARK: Extension for UIGestureRecognizerState description
